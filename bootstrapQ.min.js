...
qiao.ajax=function(a){if(a){a=qiao.ajaxopt(a);a.url=base+a.url;var b;$.ajax(a).done(function(c){b=c});return b}else alert("need options")};qiao.on=function(a,b,c){$(document).off(b,a).on(b,a,c)};bootstrapQ={};bootstrapQ.modaloptions={url:"",fade:"fade",close:true,title:"title",btn:false,okbtn:"\u7ead\ue1bc\u757e",qubtn:"\u9359\u6828\u79f7",msg:"msg",big:false,show:false,remote:false,backdrop:"static",keyboard:true,style:""};
...
bootstrapQ.alert=function(a,b){var c=$.extend({},bootstrapQ.modaloptions);c.title="\u93bb\u612e\u305a";if(typeof a=="string")c.msg=a;else $.extend(c,a);$("body").append(bootstrapQ.modalstr(c));var d=$("#bsmodal");d.modal(c);qiao.on("button.bsok","click",function(){b&&b();d.modal("hide")});qiao.on("#bsmodal","hidden.bs.modal",function(){d.remove()});d.modal("show")};
bootstrapQ.confirm=function(a,b,c){var d=$.extend({},bootstrapQ.modaloptions);if(typeof a=="string")d.msg=a;else $.extend(d,a);d.btn=true;d.title="\u7ead\ue1bf\ue17b\u93bf\u5d84\u7d94";$("body").append(bootstrapQ.modalstr(d));var e=$("#bsmodal");e.modal(d);qiao.on("button.bsok","click",function(){b&&b();e.modal("hide")});qiao.on("button.bscancel","click",function(){c&&c();e.modal("hide")});qiao.on("#bsmodal","hidden.bs.modal",function(){e.remove()});e.modal("show")};
...
bootstrapQ.bstroopts={prevButtonText:"\u6d93\u5a41\u7af4\u59dd\ufffd",finishButton:'<button class="btn btn-lg btn-success bootstro-finish-btn"><i class="icon-ok"></i>\u7039\u5c7e\u579a</button>',stopOnBackdropClick:false,stopOnEsc:false};
