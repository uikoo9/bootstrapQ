$.fn.qdata=function(){var a={},b=$(this).attr("data");if(b){b=b.split(";");for(var c=0;c<b.length;c++)if(b[c]){var d=b[c].split(":");a[d[0]]=d[1]}}return a};var qiao={};qiao.ajaxoptions={url:"",data:{},type:"post",dataType:"json",async:false};qiao.ajaxopt=function(a){var b=$.extend({},qiao.ajaxoptions);if(typeof a=="string")b.url=a;else $.extend(b,a);return b};qiao.ajax=function(a){if(a){var b;$.ajax(qiao.ajaxopt(a)).done(function(c){b=c});return b}else alert("need options")};
qiao.on=function(a,b,c){$(document).off(b,a).on(b,a,c)};bootstrapQ={};bootstrapQ.modaloptions={url:"",fade:"fade",close:true,title:"title",head:true,foot:true,btn:false,okbtn:"\u786e\u5b9a",qubtn:"\u53d6\u6d88",msg:"msg",big:false,show:false,remote:false,backdrop:"static",keyboard:true,style:"",mstyle:""};
bootstrapQ.modalstr=function(a){var b='<div class="modal '+a.fade+'" id="bsmodal" tabindex="-1" role="dialog" aria-labelledby="bsmodaltitle" aria-hidden="true" style="position:fixed;top:20px;'+a.style+'">';b+=a.big?'<div class="modal-dialog modal-lg" style="'+a.mstyle+'"><div class="modal-content">':'<div class="modal-dialog" style="'+a.mstyle+'"><div class="modal-content">';var c="";if(a.head){c+='<div class="modal-header">';if(a.close)c+='<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>';
c+='<h3 class="modal-title" id="bsmodaltitle">'+a.title+"</h3></div>"}var d='<div class="modal-body"><p><h4>'+a.msg+"</h4></p></div>",e="";if(a.foot){e+='<div class="modal-footer"><button type="button" class="btn btn-primary bsok">'+a.okbtn+"</button>";if(a.btn)e+='<button type="button" class="btn btn-default bscancel">'+a.qubtn+"</button>";e+="</div>"}return b+c+d+e+"</div></div></div>"};
...
a)}};bootstrapQ.bsdateoptions={autoclose:true,language:"zh-CN",format:"yyyy-mm-dd"};bootstrapQ.bsdate=function(a,b){if(a){a=$(a);if(a.length>0){var c=$.extend({},bootstrapQ.bsdateoptions,b);a.each(function(){$(this).datepicker(c)})}}};
