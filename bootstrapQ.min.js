...
bootstrapQ.confirm=function(a,b,c){var d=$.extend({},bootstrapQ.modaloptions);d.title="\u7ead\ue1bf\ue17b\u93bf\u5d84\u7d94";if(typeof a=="string")d.msg=a;else $.extend(d,a);d.btn=true;$("body").append(bootstrapQ.modalstr(d));var e=$("#bsmodal");e.modal(d);qiao.on("button.bsok","click",function(){b&&b();e.modal("hide")});qiao.on("button.bscancel","click",function(){c&&c();e.modal("hide")});qiao.on("#bsmodal","hidden.bs.modal",function(){e.remove()});e.modal("show")};
